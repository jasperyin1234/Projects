...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM userlist WHERE userName = '" . $username . "' AND userPw = '" . hash('gost', $password) . "' AND
			userType = '". $userType . "'";
    ...
    if ($rowcount == 1) {
        ...
        header("Location:adminLogin.php?message=loginfail");
    }
...
<body>
    ...
    <h1 id="loginheader">Admin Account Login</h1>
