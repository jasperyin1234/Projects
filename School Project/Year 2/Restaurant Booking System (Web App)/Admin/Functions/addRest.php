...
<body>
	...
	<h2 id='adminPageHeader'>Register Restaurant</h2>
	
	<form  action='/Group 11/Admin/Functions/modify/Uploads.php' method='POST' enctype='multipart/form-data'>
		<div id='allDetails'>
			<div id='Details'>
		...
		<div id='putRestImg'> 
			...
			<input id='doneRegister' type='submit' name ='Confirm_Registration' value='Confirm_Registration'>
