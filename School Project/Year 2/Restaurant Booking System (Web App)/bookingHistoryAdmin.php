...
<head>
    <meta charset="UTF-8" />
    <title>View User's Booking History</title>
...
<body>
    ...
    <h2>View User's Booking History</h2>
    <button type="button" class="backButton">
		<span class="backButtonIcon"><ion-icon name="arrow-back-outline"></ion-icon></span>
            <span class="backButtonText"><a href="/Group 11/userProfileAdminView.php?userID=<?php echo $userID?>">Back</a></span>
</button><hr>
